		...
		<div id="content">
			<div class="sub_con">
				...
				<div class="right_con">	
					...
					<form id='writeBoard' method='post' action='insert.php' enctype='multipart/form-data'>
						<div class="article_box">
							<table class="not_wrt">
								...
								<td colspan='3' class='tb_title'><input type='text' class="inptxt wsubject" name='title'/></td>
								</tr></thead>
								<tbody>
								<th class='write_caption'>작성자</th> 
									<td colspan='3' class='tb_title'><input type='text' class="inptxt wsubject" name='name'/></td>
